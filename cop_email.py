...
#Email
password = keyring.get_password("email", "xx")
...
Over the past few months, since initially raising my hand for severance, I took time to reflect on my career at ConocoPhillips. To my surprise, the thoughts did not flow to an exciting project, a great performance review, supervising offshore, inking a big deal, or all the money earned and or saved, it was you, the people I met and relationships built.

Our time together was wonderful and it was co-workers like yourself that made my career so fulfilling and ultimately the decision to EOI so difficult. I appreciate you and each second we spent together over the past 14 years.  Thank you for being awesome and a special part of my family and I's life.
...
<li> Call - my number is 309.253.7887 
...
Stephen Read
Dad, Engineer, Coder, Investor, Writer
